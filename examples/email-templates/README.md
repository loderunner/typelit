...
- `order-confirmation.ts` - Order confirmation (currency, dates, complex
  nesting)
...
**Order Confirmation** - Custom currency formatter, date formatter, deeply
nested data
...
TypeScript catches errors at compile time. Try uncommenting the error examples
in each file to see what TypeScript catches.
